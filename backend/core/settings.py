...
# Parse DEBUG safely from environment variable (defaults to True if missing)
DEBUG = os.getenv('DJANGO_DEBUG', 'True').lower() in ('true', '1', 't', 'yes')

# Parse ALLOWED_HOSTS safely from comma-separated string
...
STATIC_URL = 'static_' if 'static_' in locals() else 'static/'
STATIC_URL = 'static/'
